...
<html>
<head>
  <title>Resume Data Sugestion System [SS]</title>
                                ...
                                <?php
                                    ...
                                    if ($role !== "super admin"){
                                        ...
                                        if ($jbt == "FRM"){
                                                ...
                                                LEFT JOIN kategori ON buat_ss.id_kategori = kategori.id_kategori WHERE nilai>0 AND `group`='$grp'") or die (mysqli_error($con)); 
                                                $nil = "scoring_frm.php";
                                        }
                                        ...
                                        if ($jbt =="SPV"){
                                                ...
                                                LEFT JOIN group_tb ON karyawan.group = group_tb.id_group
                                                LEFT JOIN shift ON karyawan.shift = shift.id_shift
                                                LEFT JOIN kategori ON buat_ss.id_kategori = kategori.id_kategori WHERE nilai >= 58 AND section = '$sec'") or die (mysqli_error($con)); 
                                                $nil = "scoring_spv.php";                              
                                        }elseif ($jbt == "MNG"){
                                                $score = mysqli_query ($con,"SELECT buat_ss.npk AS npk, karyawan.npk AS npk_kar, buat_ss.id_buat AS id,karyawan.nama, kategori.id_kategori, buat_ss.judul, dept.nama_dept, group_tb.nama_group,
                                                shift.id_shift, buat_ss.periode, buat_ss.nilai, buat_ss.nominal, buat_ss.progress
                                                ...
                                                LEFT JOIN group_tb ON karyawan.group = group_tb.id_group
                                                LEFT JOIN shift ON karyawan.shift = shift.id_shift
                                                LEFT JOIN kategori ON buat_ss.id_kategori = kategori.id_kategori WHERE nilai >=79 AND dept_fungsion = '$fung'") or die (mysqli_error($con)); 
                                                $nil = "scoring_mng.php";                                                            
                                        }elseif ($jbt == "DIV"){
                                                $score = mysqli_query ($con,"SELECT buat_ss.npk AS npk, karyawan.npk AS npk_kar, buat_ss.id_buat AS id,karyawan.nama, kategori.id_kategori, buat_ss.judul, dept.nama_dept, group_tb.nama_group,
                                                shift.id_shift, buat_ss.periode, buat_ss.nilai, buat_ss.nominal, buat_ss.progress
                                        ...
                                        $score = mysqli_query ($con,"SELECT buat_ss.npk AS npk, karyawan.npk AS npk_kar, buat_ss.id_buat AS id,karyawan.nama, kategori.id_kategori, buat_ss.judul, dept.nama_dept, group_tb.nama_group,
                                                                        ...
                                                                        LEFT JOIN group_tb ON karyawan.group = group_tb.id_group
                                                                        LEFT JOIN shift ON karyawan.shift = shift.id_shift
                                                                        LEFT JOIN kategori ON buat_ss.id_kategori = kategori.id_kategori WHERE nilai>0 ") or die (mysqli_error($con));   
                                                                        $nil = "scoring_frm.php";                                                   
                                    }                        
...
<div class="row">
        <div class="col-sm-4 text-center">
            <span class="box pull-center">                    
                <a href ="detail_ss.php" class="btn btn-info">>>Kembali </a>
            </span>
        </div>
</div>
</body>
