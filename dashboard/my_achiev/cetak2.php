...
require '../../phpspreadsheet/autoload.php';
    ...
    $sheet->setCellValue('K1', 'Nonimal');
                ...
                LEFT JOIN kategori ON buat_ss.id_kategori = kategori.id_kategori WHERE karyawan.npk = '$npk' AND nilai >=0 AND buat_ss.periode BETWEEN '$_GET[dari]' AND '$_GET[ke]' ORDER BY periode ASC")or die (mysqli_error($con));
